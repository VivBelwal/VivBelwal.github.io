  ...
  const myProjects = [
    {
      ...
      image : `${style}`,
      description: "StyleCraze primarily focuses on health & wellness, skin care, hair care...",
      techStack : [
        "Java Script",
        "HTML",
        "CSS"
...
"Fixed navbar"
     ...
     },
     {
      title: "LeadIQ Clone",
      image :`${leadIQ}`,
      description: "The LeadIQ platform is built to help you prospect smarter and build pipeline faster.",
      techStack : [
        "Java Script",
        "HTML",
        "CSS"
...
"Fetching data from own server"
  ...
  return (
      <Box  bg="#1A365D" id="project" w="100%"  pt="5vw" pl="5vw" border={'1px solid green'}>
      <Text  display="flex" ml="10%" fontSize={{ lg: "40", md: "30", sm: "20.5", base: "20" }} 
          fontWeight={"400"}
          fontFamily="brushscriptmt" color="purple.200" >Project
        ...
        */}
        ...
        <SimpleGrid columns={[1,2,2,3]}  w="80%"  m="auto" mt="3vw" gap={{lg: "5px", md: "5px", sm: "2px", base: "2px"}}>
  
  {myProjects.map((projects) => (
    <Fade bottom>  
            <Box _hover={{opacity : "0.8", cursor: "pointer"}} bg='blue.500'w="80%"  pl="2vw" pr="2vw" borderRadius={"10"} > 
             
       <Text fontSize={{ lg: "20", md: "20", sm: "15", base: "15" }} pt="1" color="white" justifyContent={"center"}
           textAlign={"center"}   
          >{projects.title}</Text>
          <Image src={projects.image} alt={projects.title} pt ="1vw"/>
          <Text fontSize="15px" mt="1vw" color="white" justifyContent={"center"}
           textAlign={"center"}   
         ...
         {projects.techStack.map((tech) =>(
              <Text fontSize={{ lg: "12", md: "12", sm: "10", base: "10" }} color="white" display={"flex"} mt="1vw"
             
             >{tech}</Text>
          ))}

         </Box>
         <Box display={"flex"} mb="1vw" pb='1vw' mt="1vw" gap="5vw" fontSize={{ lg: "15", md: "15", sm: "10", base: "7" }} >
        
        <a href={projects.Glink} target="_blank"><Button >
       ...
       <Image src={`${Github}`}  w="30px" alt="github"/>
         ...
         <Button>
             <Text fontSize={{ lg: "15", md: "15", sm: "15", base: "15" }}> Netlify</Text>
            </Button>
         </a>
